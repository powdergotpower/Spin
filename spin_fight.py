#!/usr/bin/env python3
# spin_fight.py — clean Termux-friendly spin-wheel generator
...
HOLD_DURATION = 2.0                   # seconds to pause on stopped wheel
WINNER_DURATION = 4.0                 # seconds big winner screen
SPINS = 6                             # full rotations before stopping
OUTPUT_NAME = "spin_result.mp4"
AUTO_MOVE_TO_DOWNLOADS = True         # move video & refresh gallery
# ---------------------------------------

# ---------------- helpers ----------------
def find_font():
    # common fonts on Termux / Android
    candidates = [
...
if not usernames:
    raise SystemExit("usernames.txt is empty — add usernames, one per line.")
...
if FONT_PATH:
    ...
    print("Warning: no TTF font found, will use default Pillow font.")
...
wheel_base.save("wheel_preview.png")  # optional preview
