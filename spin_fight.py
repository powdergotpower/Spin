#!/usr/bin/env python3
# spin_fight.py — Termux-friendly spin wheel, save in Termux first
...
AUTO_MOVE_TO_DOWNLOADS = False   # set True only if you want to auto-copy later
# ---------------------------------------
...
if FONT_PATH:
    ...
    print("Warning: no TTF font found, using Pillow default.")
...
# ---------------- Termux save (keep in ~/Spin) ----------------
print("Video saved in Termux folder:", os.path.abspath(OUTPUT_NAME))

# Optional: later you can copy it to public Downloads manually
# Example:
# cp spin_result.mp4 /storage/emulated/0/Download/
# am broadcast -a android.intent.action.MEDIA_SCANNER_SCAN_FILE -d file:///storage/emulated/0/Download/spin_result.mp4
